...
namespace librados
{
  ...
  public:
     ...
     *
     * @param expected_size expected size of the object, in bytes
     * @param expected_write_size expected size of writes to the object, in bytes
     * @param expected_size_probability reserved - just pass zero
     */
  ...
  public:
     ...
     * @returns 0 on success, negative error code on failure
     */
    int set_alloc_hint(const std::string& o, uint64_t expected_size,
